...
These requests are demonstrated within this app, as an example to show how you can connect to Expenseriser and make requests in your own app.  The two basic requests are demo'd as follows
